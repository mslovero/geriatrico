...
const Layout = () => {
  ...
  const navItems = [
    ...
    { path: "/historial-medico", label: "Historial Médico", icon: "bi-file-medical" },
    ...
    <div className="d-flex min-vh-100 position-relative bg-body">
      ...
      >
        <div className="d-flex align-items-center justify-content-between mb-4 px-2 mt-2">
          ...
          >
            <div className="bg-white text-primary rounded-circle d-flex align-items-center justify-content-center me-3 shadow-sm" style={{width: '40px', height: '40px'}}>
        ...
        {user && (
          <div className="mb-4 p-3 rounded-3 bg-white bg-opacity-10 border border-white border-opacity-10 d-flex align-items-center">
            ...
            <div className="overflow-hidden">
              <div className="fw-bold text-truncate text-white" style={{fontSize: '0.9rem'}} title={user.name}>
                {user.name}
              </div>
              <div
        ...
        <div className="mb-3 px-2 text-uppercase text-white-50 fw-bold" style={{fontSize: '0.75rem', letterSpacing: '1px'}}>Menu Principal</div>
      ...
      >
        ...
        <header className="bg-surface shadow-sm py-3 px-4 d-flex align-items-center justify-content-between sticky-top z-1020">
          <div className="d-flex align-items-center">
            ...
            <h5 className="m-0 fw-bold text-gradient">Sistema de Gestión Integral</h5>
          </div>
          ...
          <div className="d-flex align-items-center gap-3">
             ...
             <div className="position-relative">
               ...
               {showNotifications && (
                  <div className="position-absolute end-0 mt-2 bg-white rounded-3 shadow-xl border border-light overflow-hidden fade-in" style={{ width: '320px', zIndex: 1050, top: '100%' }}>
                      <div className="p-3 border-bottom bg-surface d-flex justify-content-between align-items-center">
                          ...
                          <span className="badge bg-primary bg-opacity-10 text-primary rounded-pill">3 Nuevas</span>
                      </div>
                      <div className="list-group list-group-flush" style={{maxHeight: '300px', overflowY: 'auto'}}>
                          <a href="#" className="list-group-item list-group-item-action p-3 border-bottom-0 border-top-0 border-start-0 border-end-0">
                              <div className="d-flex align-items-start">
                                  <div className="bg-warning bg-opacity-10 text-warning rounded-circle p-2 me-3">
                                      <i className="bi bi-exclamation-triangle-fill"></i>
                                  </div>
                                  <div>
                                      <p className="mb-1 small fw-bold text-dark">Incidencia Reportada</p>
                                      <p className="mb-1 small text-muted">Paciente Juan Pérez presentó fiebre alta.</p>
                                      <small className="text-muted" style={{fontSize: '0.7rem'}}>Hace 10 min</small>
                                  </div>
                              </div>
                          </a>
                          <a href="#" className="list-group-item list-group-item-action p-3 border-bottom-0 border-start-0 border-end-0">
                              <div className="d-flex align-items-start">
                                  <div className="bg-info bg-opacity-10 text-info rounded-circle p-2 me-3">
                                      <i className="bi bi-capsule"></i>
                                  </div>
                                  <div>
                                      <p className="mb-1 small fw-bold text-dark">Recordatorio de Medicación</p>
                                      <p className="mb-1 small text-muted">Pendiente administración turno tarde.</p>
                                      <small className="text-muted" style={{fontSize: '0.7rem'}}>Hace 30 min</small>
                                  </div>
                              </div>
                          </a>
                          <a href="#" className="list-group-item list-group-item-action p-3 border-bottom-0 border-start-0 border-end-0">
                              <div className="d-flex align-items-start">
                                  ...
                                  <div>
                                      <p className="mb-1 small fw-bold text-dark">Nuevo Ingreso</p>
                                      <p className="mb-1 small text-muted">Se ha registrado un nuevo paciente.</p>
                                      <small className="text-muted" style={{fontSize: '0.7rem'}}>Hace 2 horas</small>
                                  </div>
                              </div>
                          </a>
                      </div>
                      <div className="p-2 text-center bg-light border-top">
                          <a href="#" className="small text-decoration-none text-primary fw-bold">Ver todas</a>
                      </div>
                  </div>
               )}
             </div>
        ...
        <footer className="py-4 px-4 bg-surface border-top mt-auto">
          <div className="d-flex justify-content-between align-items-center">
            <span className="text-muted small">
              &copy; {new Date().getFullYear()} <span className="fw-bold text-primary">Geriátrico Manager</span>
            </span>
