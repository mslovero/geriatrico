...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <div
        className="card card-glass shadow-xl p-5 position-relative"
        style={{
          maxWidth: "450px",
          width: "100%",
          zIndex: 1,
      ...
      >
        <div className="text-center mb-5">
          <div
            className="d-inline-flex align-items-center justify-content-center rounded-circle bg-gradient-primary text-white mb-3 shadow-lg"
          ...
          <h2 className="fw-bold text-gradient mb-5">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="form-label small text-uppercase text-muted fw-bold">
              Correo Electrónico
            </label>
          ...
          {error && (
            <div
              className="alert alert-danger d-flex align-items-center small py-2 mb-4 border-0 shadow-sm"
              role="alert"
            >
          ...
          <div className="text-center mt-4">
            <a
              href="#"
              className="small text-decoration-none text-muted hover-primary"
            >
