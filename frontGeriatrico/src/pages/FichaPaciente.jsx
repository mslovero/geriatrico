        ...
        <div className="card-body p-4">
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center border-bottom pb-4 mb-4">
            <div className="d-flex align-items-center mb-3 mb-md-0">
              <div
                className="bg-gradient-primary text-white rounded-circle d-flex align-items-center justify-content-center me-4 shadow-md flex-shrink-0"
              ...
              <div>
                ...
                <div className="d-flex flex-wrap align-items-center gap-3 text-muted">
                  <span>
                    <i className="bi bi-person-vcard me-1"></i> DNI:{" "}
                    {paciente.dni}
                  </span>
                  <span>
              ...
              <div className="p-3 bg-light rounded-3 h-100 text-center">
                ...
                <div className="fw-bold text-dark fs-5">
                  ...
                  <span className="text-muted fs-6">
                    Cama {paciente.cama?.numero || paciente.cama_id || "-"}
                  </span>
                </div>
              </div>
            </div>
                ...
                <table className="table table-hover mb-0">
                  <thead className="bg-light">
                    <tr>
                      ...
                      <th className="border-0">Cant. Mensual</th>
                      <th className="border-0">Inicio</th>
                      <th className="border-0">Fin</th>
                    </tr>
                  </thead>
                  <tbody>
                    {paciente.medicaciones &&
                    paciente.medicaciones.length > 0 ? (
                        ...
                        <tr key={med.id}>
                          ...
                          <td>
                            <span
                              ...
                              } bg-opacity-10 border border-opacity-25 rounded-pill`}
                            >
                              {med.tipo ? med.tipo.toUpperCase() : "DIARIA"}
                            </span>
                          </td>
                          <td>{med.dosis}</td>
                          <td>{med.frecuencia}</td>
                          <td>{med.cantidad_mensual || "-"}</td>
                          <td className="small text-muted">
                            {formatDate(med.fecha_inicio)}
                          </td>
                          <td className="small text-muted">
                            {formatDate(med.fecha_fin)}
                          </td>
                        </tr>
                      ))
                    ) : (
              ...
              <div className="table-responsive">
                <table className="table table-hover mb-0">
                  ...
                  <tbody>
                    ...
                    paciente.signos_vitales.length > 0 ? (
                      paciente.signos_vitales
                        ...
                        .map((sig) => (
                          <tr key={sig.id}>
                            <td className="ps-4 text-muted small">
                              {formatDateTime(sig.fecha)}
                            </td>
                            <td className="fw-bold">
                              {sig.presion_arterial || "-"}
                            </td>
              ...
              {paciente.incidencias && paciente.incidencias.length > 0 ? (
                paciente.incidencias
                  ...
                  .map((inc) => (
                    <div
                      key={inc.id}
                      className="mb-3 pb-3 border-bottom last-border-0"
                    >
        ...
        <div className="col-12">
          <div className="card border-0 shadow-sm h-100 break-inside-avoid">
            ...
            <div className="card-body p-4">
              ...
              paciente.historial_medico.length > 0 ? (
                <div className="table-responsive">
                  <table className="table table-hover mb-0">
                    <thead className="bg-light">
                      <tr>
